          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 font-bold text-sm">
                <a href="https://wa.me/9718002423" target="_blank" rel="noopener noreferrer" className="bg-white text-medical-dark px-10 py-5 rounded-2xl flex items-center justify-center space-x-3 hover:scale-105 transition-all text-xl">
                  <svg
                    viewBox="0 0 24 24"
                  ...
                  <span>WhatsApp Emergency Now</span>
                </a>
              </div>
            </div>
