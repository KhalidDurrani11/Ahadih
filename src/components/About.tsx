...
export function About() {
  ...
  const timeline = [
    ...
    { year: '2005', title: 'Global Reach', desc: 'Opened our first international research wing in collaboration with global partners.' },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            >
              ...
              <p className="text-gray-500 text-lg leading-relaxed">
                Founded over two decades ago, AHAD International Hospital has evolved from a local medical center into one of the most prestigious healthcare institutions in the region.
              </p>
              <p className="text-gray-500 text-lg leading-relaxed">
                Our journey has been defined by one singular focus: the patient. By combining international medical protocols with a deep understanding of human empathy, we've created a healing environment that feels more like home than a hospital.
              </p>
               ...
               {timeline.map((item, i) => (
                 ...
                 >
                   ...
                   <div className={`md:w-1/2 p-4 text-center ${i % 2 === 0 ? 'md:text-left md:pl-16' : 'md:text-right md:pr-16'}`}>
                      ...
                      <p className="text-gray-500 text-sm leading-relaxed max-w-sm mx-auto md:mx-0 ${i % 2 === 0 ? '' : 'md:ml-auto'}">
                        {item.desc}
                      </p>
                   </div>
                 </motion.div>
