...
export default function RootLayout({ children }: { children: ReactNode }) {
  return (
    <html lang="en">
      <body className={`${poppins.variable} ${outfit.variable} antialiased text-medical-dark bg-white flex flex-col min-h-screen selection:bg-medical-blue selection:text-white`}>
        <Navbar />
